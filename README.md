# **Spam Detection mit zwei verschiedene Ansätze**
...
Identische Daten bzw. Texte wurden entfernt, um Verzerrung (Data Leakage oder Bias) im Training zu vermeiden
...
Saubere Aufteilung in 60% Training, 20% Validation und 20% Test, um die Genereliserungsfähigkeit sicherzuerstellen.
...
**Vektorisierung**: Dabei wurde das Bag-of-Word Verfahren benutzt

**Klassifikationsalgorithmus**: Hier wurde Naive Bayes benutzt
...
**Vektorisierung**: Dabei wurde der SentenceTransformer mit dem Modell "all-MiniLM-L6-v2" verwendet BGRÜDNUNG!!
